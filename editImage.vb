...
Public Class editImage
    ...
    Private Sub btnSaveImage_Click(sender As Object, e As EventArgs) Handles btnSaveImage.Click
        Try
            If String.IsNullOrEmpty(txtPhoto.Text) OrElse String.IsNullOrEmpty(StudentNumber) Then
                MessageBox.Show("You need to select a picture of the student first", "Required", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            ElseIf Directory.Exists(Application.StartupPath & "\Profile\" & StudentNumber & ".png") Then
                Directory.Delete(StudentNumber)
            Else
                picBrowserPic.Image.Save(Application.StartupPath & "\Profile\" & StudentNumber & ".png")
                updates("UPDATE tbl_queue SET image_file_name='" & StudentNumber & ".png' 
